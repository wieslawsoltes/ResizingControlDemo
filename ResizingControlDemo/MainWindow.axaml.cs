...
public partial class MainWindow : Window
{
    ...
    protected override void OnLoaded(RoutedEventArgs e)
    {
        ...
        ResizingHost.GetObservable(ResizingHostControl.SelectedResizingAdornerControlProperty)
            .Subscribe(new AnonymousObserver<ResizingAdornerControl?>(resizingAdornerControl =>
            {
